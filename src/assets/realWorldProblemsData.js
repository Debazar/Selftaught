const realWorldProblemsData = [
  ...
  { title: 'Healthcare Innovations', description: 'Explore the latest innovations in healthcare and their real-world applications.', image: 'images/health.jpg', link: '#' },
];

export default realWorldProblemsData;